...
const PrivatePolicy = () => (
  <MarkdownModal name='Private Policy'>
    # Privacy Policy {'\n\n'}

    Last revised on 01/02/2019 {'\n\n'}

    I built the Stegappasaurus app as an Open Source app. This SERVICE is provided by
    ...
    and Conditions, which is accessible at Stegappasaurus unless otherwise defined
