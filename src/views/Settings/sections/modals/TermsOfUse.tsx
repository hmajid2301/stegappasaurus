...
const TermsOfUse = () => (
  <MarkdownModal name="Terms of Use">
    # Terms & Conditions {"\n\n"}
    ...
    or to charge for its services, at any time and for any reason. We will never
    charge you for the app or its services without making it very clear to you
    exactly what you’re paying for. {"\n\n"}
    The Stegappasaurus app stores and processes personal data that you have
    provided to us, in order to provide my Service. It’s your responsibility to
    ...
    features and it could mean that the Stegappasaurus app won’t work properly
    or at all. {"\n\n"}
    ...
    by your mobile network provider, but cannot take responsibility for the app
    not working at full functionality if you don’t have access to Wi-Fi, and you
    ...
    Along the same lines, cannot always take responsibility for the way you use
    the app i.e. You need to make sure that your device stays charged – if it
    runs out of battery and you can’t turn it on to avail the Service, cannot
    accept responsibility. {"\n\n"}
    With respect to ’s responsibility for your use of the app, when you’re using
    ...
    provide information to us so that we can make it available to you. accepts
